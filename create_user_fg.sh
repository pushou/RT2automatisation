...
adduser user2
su - user1 -c "git config --global user.email 'user1' & git config --global user.name  'user1'"
su - user2 -c "git config --global user.email 'user2' & git config --global user.name  'user2'"
